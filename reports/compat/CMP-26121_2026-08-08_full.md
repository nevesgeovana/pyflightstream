# Compat report: FlightStream 26.121 (2026-08-08)
...
66 verified, 3 broken, 173 unprobed.
...
| SWEEPER_REF_VELOCITY_SAME | broken | script processing aborted at the command: the log exported before it exists, the one after it never appeared (END sentinel missing) |
