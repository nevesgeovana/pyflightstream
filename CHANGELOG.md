...
- **The v0.18.1 archive row is OWED in CITATION.cff.** A version DOI is minted
  ...
  v0.18.1 by the concept DOI until it lands: it resolves to the newest
  archived version.
...
[Unreleased]: https://github.com/nevesgeovana/pyflightstream/compare/v0.18.1...HEAD
