...
| EARS-informed requirement wording | [alistairmavin.com/ears](https://alistairmavin.com/ears/) | New requirements use the EARS sentence shapes with stable IDs, and an implemented requirement names its evidence in its own Origin line, which is what `tests/test_traceability.py` reads | convention |
