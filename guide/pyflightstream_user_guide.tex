...
\begin{frame}{Reading the compatibility matrix}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item Current evidence: 26.120 fully covered (65 {\color{statusblue}verified}, 74 {\color{statusgreen}documented}, 3 {\color{statusred}broken}, 2 removed); 26.100 partially backfilled (37 documented); 26.000 registered, honestly empty.
    \end{itemize}
    \column{0.43\textwidth}
