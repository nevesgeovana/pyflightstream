...
\begin{frame}{Pitfalls found by the probe suite (Tier 2)}
  ...
  \begin{tabular}{@{}p{5.4cm}p{1.2cm}p{6.0cm}@{}}
    ...
    \midrule
    AIR\_ALTITUDE ignores its units argument and applies feet & 26.100, 26.101, 26.120, 26.122* & set the fluid state through FLUID\_PROPERTIES, or move to 26.121, the one registered build where the same probe passes \\
