...
\end{lstlisting}
  \begin{itemize}
    ...
    \item This sample used to refuse \code{NEW\_SIMULATION} on 26.0, and stopped: that edition's own manual was read on 2026-08-10 and the command has a page citation there now. The CAD chapter is the honest example today, arriving with 26.100 and absent from every earlier build.
