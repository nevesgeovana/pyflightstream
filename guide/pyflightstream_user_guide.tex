...
\begin{frame}{Pitfalls found by the probe suite (Tier 2)}
  ...
  \vspace{2mm}
  \begin{itemize}
    \item Each carries {\color{statusred}\textbf{broken}} status for the builds named, with the committed report cited; the builder still emits them (they are grammatically valid), but the matrix and the reference warn you.
