...
\institute[]{pyflightstream 0.6.0, MIT licensed}
\date{August 2026}
...
\begin{frame}[fragile]{Versions: the YY.XXX canonical scheme}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item A vendor name can also name more than one build: 26.120 and 26.121 both ship as "26.12", and since 2026-08-04 so do 26.100 and 26.101 as "26.1". Resolution refuses such a name and lists the candidates, rather than returning one of them. Note what that means for a script you wrote earlier: a vendor name is unique only until the vendor ships the next build under it, so pass the canonical identifier.
...
resolve("26.12")           # AmbiguousVersionAliasError: 26.120 or 26.121?
[str(k) for k in known_versions()]
# ["25.000", "25.100", "26.000", "26.100",
#  "26.101", "26.120", "26.121"]
\end{lstlisting}
    ...
    \begin{tikzpicture}[node distance=6mm]
      ...
      \node[below=3mm of d,text width=36mm,font=\tiny,align=center]
...
# Every command the four registered manual editions document is
