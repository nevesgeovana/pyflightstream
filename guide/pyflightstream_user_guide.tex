...
\begin{frame}{Guide roadmap}
  ...
  \begin{description}
    ...
    \item[Part II] Hands on: your first validated script in ten minutes, and the tour of the 21 curated helpers.
...
\begin{frame}{What each layer owns}
  ...
  \begin{tabular}{@{}lp{5.2cm}p{4.6cm}@{}}
    ...
    script & validating emission, phase order, layouts, helpers & \code{Script}, 21 curated helpers \\
...
\begin{frame}{Why helpers, and why only 21}
  \begin{columns}[T]
    \column{0.55\textwidth}
    \begin{itemize}
    ...
    \small
    \begin{block}{The 21}
      free\_stream, atmosphere, solver\_settings, initialize\_solver, start\_solver, coordinate\_frame, sweep, analysis\_setup, export\_results, probe\_points, probe\_line, probes\_from\_file, export\_probes, actuator\_disc, rotary\_motion, unsteady\_solver, azimuth\_basis, blade\_frames, rotate\_surfaces, unsteady\_action, mark\_wake\_edges
    \end{block}
  \end{columns}
\end{frame}
