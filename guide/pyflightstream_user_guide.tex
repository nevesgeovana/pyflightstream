...
\institute[]{pyflightstream 0.8.0, MIT licensed}
\date{August 2026}
...
\begin{frame}{Guide roadmap}
  ...
  \begin{description}
    ...
    \item[Part II] Hands on: your first validated script in ten minutes, and the tour of the 23 curated helpers.
...
\begin{frame}{What each layer owns}
  ...
  \begin{tabular}{@{}lp{5.2cm}p{4.6cm}@{}}
    ...
    script & validating emission, phase order, layouts, helpers & \code{Script}, 23 curated helpers \\
...
\begin{frame}{Why helpers, and why only 23}
  \begin{columns}[T]
    \column{0.55\textwidth}
    \begin{itemize}
