...
\institute[]{pyflightstream 0.4.0, MIT licensed}
\date{August 2026}
...
\begin{frame}[fragile]{Versions: the 26.XXX canonical scheme}
  \begin{columns}[T]
    ...
    \begin{itemize}
      ...
      \item A vendor name can also name more than one build: 26.120 and 26.121 both ship as "26.12". Resolution refuses such a name and lists the candidates, rather than returning one of them.
...
\end{lstlisting}
    ...
    \begin{tikzpicture}[node distance=6mm]
      ...
      \node[draw=deepblue,thick,rounded corners,fill=softgray,minimum width=30mm,below=of b] (c) {26.120};
