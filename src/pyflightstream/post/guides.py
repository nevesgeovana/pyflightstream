...
def _equations_page() -> str:
    ...
    lines = [
        ...
        "stage warning, and a rebuild archives it with the products. Frozen",
        "solves and unread blocks warn by default; `--check-frozen` asks to",
        "refuse affected averages instead.",
        "",
