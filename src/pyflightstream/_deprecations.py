...
WAIVED_COMMANDS_MANIFEST_KEY = DeprecatedManifestKey(
    ...
    extra=(
        ...
        "THE 74 ARE IN THIS REPOSITORY and not in a user's workspace, which the paths "
        "above say and this sentence refuses to let a reader skim past: the pre-0.22.0 "
        "readings were taken over a separate research tree. A fixture is regenerable "
        "and a user's manifest is not, so the argument for keeping the reader rests on "
        "a population this count does not cover; re-counting over a live user workspace "
        "is OWED rather than claimed. "
        ...
        "the entry carried before THIS bump is the 74 above, which did reproduce. It said "
        ...
        "at 18 rows across 6 live manifests. THAT IS THE SECOND OF THE TWO READINGS "
