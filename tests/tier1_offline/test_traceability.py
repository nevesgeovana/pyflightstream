...
#: `tests/tier1_offline/test_error_messages.py`. Three requirements and three markers
...
#: mypy recount 2026-09-24: 761 errors in 18 of 100 modules (reports/RPT-029).
...
RECOUNT_RECORDS = (
    ...
    "pyproject.toml",
    "tests/tier1_offline/test_traceability.py",
