...
in ``tests/tier1_offline/test_house_style.py``. That module owns the meaning of a counted
...
PRIVATE_ID_COUNTS: dict[str, int] = {
    ...
    # repository was created. A row left at zero would silently cover a
    ...
    "tests/tier1_offline/test_build_table.py": 1,
    "tests/tier1_offline/test_clean_room.py": 1,
    "tests/tier1_offline/test_command_db.py": 5,
    "tests/tier1_offline/test_conventions.py": 1,
    "tests/tier1_offline/test_digest.py": 1,
    "tests/tier1_offline/test_error_messages.py": 2,
    "tests/tier1_offline/test_evidence_provenance.py": 3,
    "tests/tier1_offline/test_exceptions_catalog.py": 4,
    "tests/tier1_offline/test_extras_isolation.py": 6,
    "tests/tier1_offline/test_guide_api_names.py": 1,
    "tests/tier1_offline/test_guide_currency.py": 2,
    "tests/tier1_offline/test_house_style.py": 2,
    "tests/tier1_offline/test_mutation_harness.py": 1,
    "tests/tier1_offline/test_overview.py": 2,
    "tests/tier1_offline/test_qa_cli.py": 1,
    "tests/tier1_offline/test_qa_compat.py": 5,
    "tests/tier1_offline/test_qa_physics.py": 1,
    "tests/tier1_offline/test_qa_probes.py": 1,
    "tests/tier1_offline/test_reference.py": 1,
    "tests/tier1_offline/test_results.py": 1,
    "tests/tier1_offline/test_run.py": 1,
    "tests/tier1_offline/test_run_campaign.py": 3,
    "tests/tier1_offline/test_run_preproc.py": 1,
    "tests/tier1_offline/test_script.py": 7,
    "tests/tier1_offline/test_solver_setup.py": 2,
    "tests/tier1_offline/test_traceability.py": 2,
    "tests/tier1_offline/test_utils_manual.py": 3,
    "tests/tier1_offline/test_version_identity.py": 1,
    "tests/tier1_offline/test_yamlflow.py": 2,
}
