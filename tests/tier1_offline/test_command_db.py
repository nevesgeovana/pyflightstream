...
def test_meta_canonical_identifiers_are_unique():
    ...
    # tests/tier1_offline/test_versions.py (test_a_shared_alias_is_refused_and_names_
...
def test_every_alias_is_the_vendor_name_of_its_own_canonical():
    ...
    no guard at all: the behavioural tests in tests/tier1_offline/test_versions.py
...
def test_every_declared_sentinel_and_length_is_reachable_from_the_database():
    ...
    pass unnoticed; the behavioural guards live in tests/tier1_offline/test_script.py
...
def test_no_chapter_file_records_a_version_twice():
    ...
    offenders = []
    root = Path(__file__).parents[2] / "src" / "pyflightstream" / "commands"
