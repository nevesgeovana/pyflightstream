...
def _stage_fsi_run(tmp_path: Path) -> Path:
    ...
    from tests.tier1_offline.test_fsi_driver import stage_run, write_loads
...
def test_mach_and_advance_ratio_separate_two_rows(tmp_path):
    ...
    # over a two-point sweep. The FOLDER they collect into is each point's
    # own since 0.16.0 (FR-92); what they would still collide in is the
    # product tree, which names a point's products after this stem.
