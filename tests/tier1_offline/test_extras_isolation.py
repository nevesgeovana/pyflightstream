...
``tests/tier1_offline/test_utils_manual.py`` from the release's first commit, every
...
name, for the reason ``tests/tier1_offline/test_house_style.py`` records above its own
...
#: `tools/` and are run by `tests/tier1_offline/test_repository_guards.py`. The count
