...
def test_resolve_recipe_validates_the_reference_form():
    ...
    resolved = resolve_recipe("tests.tier1_offline.test_cases:protocol_recipe")
...
def test_resolve_recipe_refuses_the_loose_builder_signature():
    ...
    with pytest.raises(
        ...
        resolve_recipe("tests.tier1_offline.test_cases:loose_recipe")
...
# tests/tier1_offline/test_matrix.py, and the two are held to one owner there.
