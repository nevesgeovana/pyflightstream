...
CLAUDE.md documents three environment variables that a fresh clone must set
(`PYFS_PLAN_CHECKER`, `PYFS_INCIDENT_LEDGER`, `PYFS_SESSION_ROOT`), and the
...
def test_the_documented_set_is_derived_and_not_empty() -> None:
    ...
    asserts the floor: the three long-standing variables are present.
    """
    documented = _documented()
